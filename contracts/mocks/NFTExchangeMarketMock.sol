...
contract NFTExchangeMarketMock is ERC721HolderUpgradeable, ERC1155HolderUpgradeable, ERC20Tokens {
    ...
    mapping(uint => uint) public onShelfCommodityIdIndex;
    ...
    mapping(address => uint[]) public buyerCommodityIds;

    function initialize(IContract _token, address payable _handlingFeeAccount, address[] memory _token20sAddress) public initializer {
     ...
     */
    function deleteNFTCommodity(uint _commodityId) public {
    ...
    function getOnShelfCommodityIds() public view returns (uint[] memory) {
        return onShelfCommodityIds;
    }
    ...
    function getSellerCommodityIds() public view returns (uint[] memory) {
        return sellerCommodityIds[_msgSender()];
    }
    ...
    function getTokenCommodityIds(uint _tokenId) public view returns (uint[] memory) {
        return tokenIdOfCommodityIds[_tokenId];
    }
    ...
    function getBuyerCommodityIds() public view returns (uint[] memory) {
        return buyerCommodityIds[_msgSender()];
    }
