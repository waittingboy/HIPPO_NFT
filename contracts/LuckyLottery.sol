...
contract LuckyLottery is OwnableUpgradeable, ILuckyLottery {
    ...
    address[] private rewardToken20s;
    ...
    mapping(uint => LotteryPool) private lotteryPools;
    ...
    function drawLottery(uint _poolId) public override {
        ...
        console.log("lotteryPool.lotteryTimes is:",lotteryPool.lotteryTimes);
